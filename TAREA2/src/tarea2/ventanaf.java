...
public class ventanaf extends javax.swing.JFrame {
    ...
    public ventanaf(Usuario personaje[]) {
    ...
    String tabla[][] = new String[personaje.length][3];    
    
      for(int i=0;i<personaje.length;i++){
            if(personaje[i]!=null){
                
                tabla[i][0] = personaje[i].getNombre();
                tabla[i][1] = personaje[i].getApellido();
                tabla[i][2] = personaje[i].getCarnet();
            }            
        }  
    ...
    private void initComponents() {
        ...
        Tablau.setBackground(new java.awt.Color(204, 204, 204));
        Tablau.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
